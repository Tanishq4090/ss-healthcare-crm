      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              {/* Instagram */}
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-brand-blue hover:text-white hover:border-brand-blue transition-all">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
        ...
        <div className="border-t border-gray-800 dark:border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-xs text-gray-500 font-medium tracking-wide">
            © 2025 SS Health Care — All Rights Reserved | Powered by 99FIX ALL FACILITIES & SERVICES
          </p>
